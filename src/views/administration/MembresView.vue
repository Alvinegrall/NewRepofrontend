<template>
  <div>
    ...
    <HeaderBreadcrumbs :links="breadcrumbItems" title="Liste des membres" />
    <HeaderWithOptions
      :btnLabel="['Créer un membre']"
...
import TableSampleMembres from "@/components/common/TableSampleMembres.vue";
...
const createMembre = () => {
  router.push({
    name: "administration.newmembres",
  });
