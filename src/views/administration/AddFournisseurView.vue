...
<template>
  <div>
    ...
    <HeaderBreadcrumbs :links="breadcrumbItems" title="Liste des fornisseurs" />

    <HeaderWithOptions
      :btnLabel="['Créer un fournisseur']"
    ...
    <CardBox class="mb-6" has-table>
      <TableFournisseurs :details="fournisseur" />
    </CardBox>
  </div>
</template>
