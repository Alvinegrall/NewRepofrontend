...
import TableMagasins from "@/components/TableMagasins.vue";
...
const createCat = async () => {
  ...
  store
    .dispatch("magasins/createMagasin", { name: fields.name })
    .then(async (response) => {
...
<template>
  <div>
    ...
    <HeaderBreadcrumbs :links="breadcrumbItems" title="Liste des magasins" />

    <HeaderWithOptions
      :btnLabel="['Créer un magasin']"
    ...
    <CardBox class="mb-6" has-table>
      <TableMagasins :details="magasins" />
    </CardBox>
  </div>
</template>
