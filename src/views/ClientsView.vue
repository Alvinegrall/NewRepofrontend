  ...
  <div class="page-container-wrapper">
    <div class="mb-4 flex justify-between items-center flex-wrap gap-4">
      ...
      <div id="les-actions" class="flex gap-2 md:gap-4 p-3">
        ...
        >
          <vue-feather
            class="scale-50 md:scale-75 hidden sm:inline"
            type="eye"
          ></vue-feather>
    ...
    <div class="row">
      <ClientListSection :loading="loading" />
    </div>
  </div>
</template>

<script>
import ClientListSection from "../components/clients/ClientListSection.vue";
import BaseButton from "../components/common/BaseButton.vue";

export default {
  components: { ClientListSection, BaseButton },
  data() {
    return {
      loading: true,
    };
  ...
  async mounted() {
    await this.$store.dispatch("clients/listclients");
    this.loading = false;
  },
};
</script>
