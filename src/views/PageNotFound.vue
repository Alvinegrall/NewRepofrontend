<template>
  ...
  >
    ...
    >
      <div class="w-full md:w-1/2">
        ...
        <div class="mb-10 md:mb-20 text-gray-600 font-light">
          ...
          <p>
            Essayez de chercher à nouveau ou utilisez le bouton Retour
            ci-dessous.
          </p>
        </div>
        <div class="mb-20 md:mb-0">
          <router-link
            to="/"
            class="text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-primary hover:text-yellow-600"
          >
            <i class="mdi mdi-arrow-left mr-2"></i>Retourner
          </router-link>
        </div>
      </div>
    ...
    <div
      class="w-64 md:w-96 h-96 md:h-full bg-gray-600 bg-opacity-30 absolute -top-64 md:-top-96 right-20 md:right-32 rounded-full pointer-events-none -rotate-45 transform"
    ></div>
    <div
      class="w-96 h-full bg-green-300 bg-opacity-20 absolute -bottom-96 right-64 rounded-full pointer-events-none -rotate-45 transform"
    ></div>
  </div>
